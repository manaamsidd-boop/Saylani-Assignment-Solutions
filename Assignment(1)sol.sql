...
-- Row count: production.products has 321 rows in BikeStores,
-- so 10 PERCENT returns 33 rows .
...
SELECT CONCAT(first_name, ' ', last_name) AS full_name, c.email
